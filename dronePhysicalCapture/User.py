...
with open("user_db","w") as f:
    f.write(f"{to_b64(JIDu_prime)},{to_b64(Id)},{to_b64(Nu_prime)},{q},{Qu},{PIDu}")
...
JIDu = xor_bytes([JIDu_prime, h(delta_u_prime.hex() + IDu).encode() ])
